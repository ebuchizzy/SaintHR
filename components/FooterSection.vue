<template>
    <footer class="bg-gray-900 text-white py-12">
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div class="flex items-center mb-4">
              <!-- <img src="~/assets/images/Logo.png" alt="Logo" class="h-8 w-auto filter brightness-0 invert" /> -->
              <span class="ml-2 font-bold text-xl">ProductName</span>
            </div>
            <p class="text-gray-400 mb-4">
              Modern solutions for modern problems. Simplify your workflow and boost productivity.
            </p>
        ...
        <div class="pt-8 mt-8 border-t border-gray-800 text-center md:text-left">
          <p class="text-gray-400">    
            &copy; 2025 ProductName. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
